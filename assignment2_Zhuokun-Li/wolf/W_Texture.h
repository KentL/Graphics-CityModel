...
class Texture
{
	...
	public:
		...
		void loadTextureDescriptor(const std::string& filename);
		texture_category* getCategoryByName(const std::string& name);
		//-------------------------------------------------------------------------
	...
	private:
		...
		texture_category* tex_categories;
		int texture_category_amount;
		//-------------------------------------------------------------------------
};
